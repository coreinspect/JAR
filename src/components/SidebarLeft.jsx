   ...
   return (
      <section ref={ref} className="sidebarLeft">
         ...
         <div className="links">
            {userState.userInfo && (
               <div className="add-post-btn">
                  <Link to={`/add-post/`}>
                     <button className="edit-post">Add Post</button>
                  </Link>
               </div>
            )}
            <ul>
         ...
         <div className="copyright">
            <h2>JAR Community</h2>
            <p className="desc">
               Enter a world where code transforms into connections. Our
               developer community, crafted by a 3-person <span>Jury</span>,{" "}
               <span>Andro</span>, and <span>RJ</span>, passionate about web
               development, is where innovation and brilliance come alive. Join
